...
class Test_Usuario():
    ...
    def test_criar_usuario_por_dict(self):
        ...
        assert usuario.contato.emails[1].email == 'novo@email.com'
        assert usuario.contato.emails[1].tipo == TipoEmail.TRABALHO
        assert usuario.contato.emails[1].prioridade == 2
